...
- Batch source fields show their current common value or a mixed-value state, support Enter or Apply, and explicitly validate tap power against rated power.
