...
- Editable project-wide outdoor equipment qualification criteria for weatherproof loudspeakers (default 124 dB(A) at 1 m), flameproof / hazardous-area loudspeakers (default 119 dB(A) at 1 m), or a custom minimum, with optional per-source and batch overrides evaluated at rated power.
